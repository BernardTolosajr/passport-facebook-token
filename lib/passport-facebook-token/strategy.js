...
FacebookTokenStrategy.prototype.authenticate = function(req, options) {
  ...
  accessToken = code || req.query.code || req.headers.code;
  refreshToken = refreshToken || req.query.code || req.headers.refresh_token;
  
  if (!accessToken) {
	  return this.fail();
  }

  this._oauth2.getOAuthAccessToken(code, { grant_type: 'authorization_code', redirect_uri: this._redirectURL},
